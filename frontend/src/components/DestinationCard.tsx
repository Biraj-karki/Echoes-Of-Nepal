    ...
    return (
        <div className="bg-slate-900/50 border border-white/10 rounded-2xl overflow-hidden hover:border-white/20 transition-all flex flex-col group cursor-pointer relative shadow-lg">
            <div className="h-40 w-full overflow-hidden relative">
                ...
                {destination.rating && (
                    <div className="absolute top-2 right-10 flex items-center gap-1 text-yellow-400 text-xs font-bold bg-black/60 backdrop-blur-md border border-white/5 px-1.5 py-1 rounded-md shadow-sm">
