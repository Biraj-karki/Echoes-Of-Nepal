...
export default function LandingHero() {
    ...
    // If user is already logged in, the parent page will switch to MapHome.
    // But just in case this is used standalone at /landing, we can keep the links.
    ...
    return (
        <main className="min-h-screen bg-[#020617] text-slate-100">
            {/* Global Navbar is in layout.tsx */}
                    ...
                    <div className="max-w-3xl">
                        ...
                        <div className="mt-6 text-sm text-slate-300/70">
                            {loading ? (
                                ...
                                <>
                                    New here? <Link href="/login" className="underline underline-offset-4">Create an account</Link>
                                </>
                            )}
                        </div>
                    </div>
